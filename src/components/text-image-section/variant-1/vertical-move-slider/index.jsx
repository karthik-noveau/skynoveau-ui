...
import Image from "@skynoveau-ui/assets/text-image-block/saree-img.jpg";

export const ProductCompareSlider = ({
  oldImage = Image,
  newImage = Image,
}) => {
  ...
  useEffect(() => {
    if (isVisible) {
      ...
      }, 200); // Small delay to initiate the animation smoothly
    }
  }, [isVisible]);
    ...
    <div className={`${styles.sliderContainer}`} ref={containerRef}>
      ...
      <div
        ...
        style={{
          ...
          transition:
            isVisible && hasAnimated ? "width 0.5s ease-in-out" : "none", // Smooth transition for animation
        }}
      />
      <div
        ...
        style={{
          left: `${sliderPosition}%`,
          transition:
            isVisible && hasAnimated ? "left 0.5s ease-in-out" : "none", // Smooth transition for the vertical line
        }}
      >
        <span
